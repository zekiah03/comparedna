...
## 思考の手順
1. 改造によって **どの13軸・metrics が大きく変わり、どの層が影響を受けるか** を推論
2. 4クラスター構造で影響を整理する:
   - Cluster I (物質: A,B,C): 素材・エネルギー・入出力が変わるか
   - Cluster II (情報: D,E,F): 判断力・耐性・依存度が変わるか
   - Cluster III (関係: G,H,I): 社交性・影響力・排他性が変わるか
   - Cluster IV (時間: J,K,L,M): 流れ・自己像・寿命・**複製力**が変わるか
...
- **M(複製力)変化**: M が上がる改造(ウイルス化、デジタル化)は伝播力・影響が劇的に変わる
